...
class ShotsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create shot" do
    assert_difference('Shot.count') do
      post shots_url, params: { shot: { discription: @shot.discription, title: @shot.title, user_id: @shot.user_id } }
    end
  ...
  test "should update shot" do
    patch shot_url(@shot), params: { shot: { discription: @shot.discription, title: @shot.title, user_id: @shot.user_id } }
